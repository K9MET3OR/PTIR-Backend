...
class Taxi(models.Model):
    ...
    tipo_motor = models.CharField(max_length=50, choices=[('Combustão', 'Combustão'), ('Elétrico', 'Elétrico')], default='Combustão')
    nivel_conforto = models.CharField(max_length=20, choices=[('Básico', 'Básico'), ('Luxuoso', 'Luxuoso')])
